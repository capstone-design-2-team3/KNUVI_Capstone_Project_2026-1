...
# Evaluation Log (0424) - Final Results
최종 논문 정량 평가 결과 합산

| Pipeline | Condition | PSNR ↑ | SSIM ↑ | LPIPS ↓ |
| :--- | :--- | :---: | :---: | :---: |
| **3DGS** | clean | 23.816 | 0.565 | 0.351 |
| | snow | 21.727 | 0.494 | 0.446 |
| | de-snow | 22.784 | 0.535 | 0.404 |
| **LongSplat** | clean | 26.501 | 0.777 | 0.150 |
| | snow | 24.859 | 0.732 | 0.358 |
| | de-snow | 25.846 | 0.756 | 0.174 |

결론: 기상 강건성과 2D 전처리 적용 후의 품질 회복 측면에서 일반 3DGS가 더 뛰어남을 확인. Unposed 모델은 2D 전처리로 인한 오차가 오히려 최적화에 방해 요소로 작용함.